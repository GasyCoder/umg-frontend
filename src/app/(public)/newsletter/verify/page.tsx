    ...
    <div className="flex flex-col items-center text-center max-w-lg mx-auto p-8 bg-white dark:bg-[#1e2634] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800">
      ...
      {status === "success" && (
        <>
          ...
          <h1 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">Inscription Confirmée !</h1>
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            Votre adresse email a été vérifiée avec succès. Vous recevrez désormais nos actualités.
          </p>
          <Link 
            href="/"
      ...
      {status === "error" && (
        <>
          ...
          <h1 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">Échec de vérification</h1>
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            {message}
          </p>
          <Link 
